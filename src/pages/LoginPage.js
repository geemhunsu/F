  ...
  return (
    <>
      <Grid className='백그라운드' display='block' width='100%' height='100%' fontSize='12px' backgroundColor='#fff' color='#1c1e21' lineHeight='normal'>
        <Grid className='상단랩' display='flex' width='100%' height='80%' justifyContent='center' backgroundColor='#f0f2f5'>
          <Grid display='flex' padding='200px 0 200px 0' flexDirection='row' width='960px' margin='0 0 0 90px'>
            <Grid className='좌측타이틀' width='500px' margin='100px 0 0 0' padding='0 32px 0 0' textAlign='left' itemAlign='left'>
            ...
            <Grid display='flex' flexDirection='column' textAlign='center'>
              <Grid backgroundColor='#ffff' padding='50px' textAlign='center' borderRadius='8px' margin='auto'>
                <Input placeholder='이메일 또는 전화번호' />
                <Input placeholder='비밀번호' />
                <Button>로그인</Button>
                <Text color='#1877f2'>비밀번호를 잊으셨나요?</Text>
                <hr />
                <Button width='40%' margin='20px' backgroundColor='#42b72a'>
                  새 계정 만들기
                </Button>
              </Grid>
              <Text>
