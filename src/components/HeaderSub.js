  ...
  return (
    ...
    width='307px'>
      <Grid display='flex' width='auto' alignItems='center'>
        <Image size='28' src={defaultUserImage} />
        <Text margin='0' bold size='.9rem' >사용자</Text>
      </Grid>
      <Grid height='40px' width='40px' display='flex' alignItems='center' 
      justifyContent='center'  bg='#e4e6eb' borderRadius='20px'>
        <i style={{
          backgroundImage: "url('https://static.xx.fbcdn.net/rsrc.php/v3/yS/r/9hjSjlsfbAc.png')",
          backgroundPosition: '0 -128px', backgroundSize: 'auto', width: '20px', height: '20px',
